...
public class Television extends Electrodomestico {
    ...
    // Método para calcular el consumo anual con tasa adicional del 20% si la resolución > 50 pulgadas
    @Override
    public double consumoAnual() {
        double consumoEuros = super.consumoAnual();
        if (resolucion > 50) {
            consumoEuros += consumoEuros * 0.20; // Incremento del 20% si la resolución es mayor de 50 pulgadas
        }
        return consumoEuros;
    }
