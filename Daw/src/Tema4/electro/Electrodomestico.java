...
public class Electrodomestico {
    // Enum para las marcas disponibles
    public enum Marca {
        BOSCH, SAMSUNG, LG, WHIRLPOOL, SIEMENS
    }

    // Constantes para valores por defecto
    private static final Marca DEFAULT_MARCA = Marca.BOSCH;
    ...
    public Electrodomestico(Marca marca, String modelo, double precio) {
        this.marca = marca;
        this.modelo = modelo;
        this.precio = precio;
        this.color = DEFAULT_COLOR;
    ...
    public Electrodomestico(Marca marca, String modelo, double precio, String color, int potencia, int horasDia, int diasAno, double precioEnergia) {
        this.marca = marca;
        this.modelo = modelo;
        this.precio = precio;
        this.color = color;
    ...
    // Método equals para comparar electrodomésticos por consumo anual
    @Override
    public boolean equals(Object obj) {
        ...
        Electrodomestico that = (Electrodomestico) obj;
        return Double.compare(this.consumoAnual(), that.consumoAnual()) == 0;
    }
